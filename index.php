...
<html lang="en">
    <head>
        ...
        <div class="LogoImg">
            <img src="MiniLogo.png" alt="display">
        </div>
    </head>

    <body>
        <div class="main-pic">
            <img src="animation.gif" alt="display">
        </div>
        <header class="header">
        ...
        <section class="home">
            <div class="home-content">
                <h1>I'm Silver and Welcome to my Domain</h1>
                <p>FunTimeWithSilver</p>
                
                <div class="btn-box">
                   <a href="FunTimeContacts.php">Hire Me</a>
                </div>
            </div>
